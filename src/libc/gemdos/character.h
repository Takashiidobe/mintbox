...
static inline int32_t Cauxout(int16_t c) {
  return (int32_t)trap_1_ww(0x04, c);
}
...
static inline int32_t Cconout(int16_t c) {
  return (int32_t)trap_1_ww(0x02, c);
}
...
static inline int32_t Cprnout(int16_t c) {
  return (int32_t)trap_1_ww(0x05, c);
}
...
static inline int32_t Crawio(int16_t w) {
  return (int32_t)trap_1_ww(0x06, w);
}
